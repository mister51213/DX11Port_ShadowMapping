...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_CubeModel->Initialize(m_D3D->GetDevice(), "../Engine/data/cube.txt", m_D3D->GetDeviceContext(), L"../Engine/data/wall01.dds");
	if(!result)
	{
	...
	result = m_SphereModel->Initialize(m_D3D->GetDevice(), "../Engine/data/sphere.txt", m_D3D->GetDeviceContext(), L"../Engine/data/ice.dds");
	if(!result)
	{
	...
	result = m_GroundModel->Initialize(m_D3D->GetDevice(), "../Engine/data/plane01.txt", m_D3D->GetDeviceContext(), L"../Engine/data/metal001.dds");
	if(!result)
	{
